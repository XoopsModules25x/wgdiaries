...
// ---------------- Main ----------------
\define('_MA_WGDIARIES_INDEX', 'Overview WFH Diaries');
\define('_MA_WGDIARIES_TITLE', 'WFH Diaries');
\define('_MA_WGDIARIES_DESC', 'Simple module for a diary for work from home');
\define('_MA_WGDIARIES_INDEX_DESC', "Welcome to the homepage of your new module WFH Diaries!<br>
...
\define('_MA_WGDIARIES_INDEX_LATEST_LIST', 'Last WFH Diaries');
// Submit

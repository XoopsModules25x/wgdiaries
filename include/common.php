...
\define('WGDIARIES_UPLOAD_ITEMS_PATH', \WGDIARIES_UPLOAD_PATH . '/items');
\define('WGDIARIES_UPLOAD_ITEMS_URL', \WGDIARIES_UPLOAD_URL . '/items');
...
\define('WGDIARIES_UPLOAD_CATEGORIES_PATH', \WGDIARIES_UPLOAD_PATH . '/categories');

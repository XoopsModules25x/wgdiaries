...
return (object)[
	...
	'uploadFolders'  => [
		...
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/groupusers',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/images',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/images/items',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/images/files',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/images/groups',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/images/groupusers',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/files',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/files/items',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/files/files',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/files/groups',
		XOOPS_UPLOAD_PATH . '/' . $moduleDirName . '/files/groupusers',

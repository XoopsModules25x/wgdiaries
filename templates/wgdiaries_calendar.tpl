...
<{if $items_calendar|default:''}>
    <div class="row wgd-cal-navbar">
        <div class="col-12 center">
            ...
            <a class="wgd-cal-navbar-link" href="calendar.php?filterFrom=<{$filterFromNextM}>&amp;filterTo=<{$filterToNextM}>&amp;<{$otherParams}>"><i class="fa fa-angle-right" title="<{$smarty.const._MA_WGDIARIES_CAL_NEXTYEAR}>"></i></a>
            <a class="wgd-cal-navbar-link" href="calendar.php?filterFrom=<{$filterFromNextY}>&amp;filterTo=<{$filterToNextY}>&amp;<{$otherParams}>"><i class="fa fa-angle-double-right" title="<{$smarty.const._MA_WGDIARIES_CAL_PREVYEAR}>"></i></a>
        </div>
    </div>
    <div class="row">
